...
## GET/ tableNo
This GET is used to get the bill for the customer based on the table number of the customer. The only number available in this API is 99 which represents takeout orders. 
...
ItemOrdered|	string	|Specifies the mealType ordered. Acceptable response: BurgerMeal, Salad, ChickenMeal, FishNChips, none. Menu items available change based on timestamp of order. For Example: Lunch Menu 12:00-17:00	|none
